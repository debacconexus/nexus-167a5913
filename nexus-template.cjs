...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "K School Enrollment Management";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Enrollment Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "enrollment_record_records";
'use strict';
